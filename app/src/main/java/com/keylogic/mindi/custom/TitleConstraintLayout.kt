...
class TitleConstraintLayout @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.TitleConstraintLayout) {

            defaultStrokeWidth =
                getDimension(R.styleable.TitleConstraintLayout_titleStrokeWidth, defaultStrokeWidth)
            customCornerRadius = getDimension(R.styleable.TitleConstraintLayout_titleRadius, 0f)
            isStrokeEnabled =
                getBoolean(R.styleable.TitleConstraintLayout_isTitleStrokeEnabled, true)
            isAllSideStoke = getBoolean(R.styleable.TitleConstraintLayout_isAllSideStoke, false)

            if (hasValue(R.styleable.TitleConstraintLayout_titleHeight)) {
                customHeight = getDimension(R.styleable.TitleConstraintLayout_titleHeight, 0f)
            }
        }
