...
class StoreConstraintLayout @JvmOverloads constructor(
    ...
    init {
        val a = context.obtainStyledAttributes(attrs, R.styleable.StoreConstraintLayout)
        borderWidth = a.getDimension(R.styleable.StoreConstraintLayout_borderWidth, borderWidth)
        cornerRadius = a.getDimension(R.styleable.StoreConstraintLayout_borderRadius, 0f)
        a.recycle()
