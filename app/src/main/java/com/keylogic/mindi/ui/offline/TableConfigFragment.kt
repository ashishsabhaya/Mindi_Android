...
class TableConfigFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.topTitleInclude.titleTxt.text = requireContext().resources.getString(R.string.create_table)
        binding.topTitleInclude.chipCountTxt.text = CommonHelper.INSTANCE.getTotalChip()
        binding.configInclude.createBtnTxt.text = requireContext().resources.getString(R.string.create)
